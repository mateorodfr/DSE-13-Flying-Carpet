...
class MotorParameters(object):
    ...
    def getMotorParameters(self,printParameters=False):
        ...
        self.Parameters_motor = [self.Name_motor, self.N_motor,self.R_motor,self.Torque,self.P_max, self.M_motor, self.SF_rotational]
        if printParameters:
            ...
            + f'\n\tSafety Factor for Motor Moment of Inertia: {self.Parameters_motor[6]} [-]'

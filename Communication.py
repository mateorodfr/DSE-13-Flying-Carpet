...
La=  -0.5904 * L_cable1 -0.5904 * L_cable2  #Transmission path loss
Ll= -0.5904 * 3  #Loss factor antenna
Lpr= -14 #Pointing error loss
#Lr= ...  # Any other losses that may occur

#Power & gains
P_trans_max= 10*np.log10(50)



P_receiver_max= P_trans_max + G_receiver+ G_trans + Lfs + La + Ll + Lpr
